...
import com.binarywalllabs.ui.activity.PlayYoutubeActivity;
...
public class PlaylistCardAdapter extends RecyclerView.Adapter<PlaylistCardAdapter.ViewHolder> {
    ...
    private final PlayListFragment.LastItemReachedListener mListener;
    ...
    public PlaylistCardAdapter(PlaylistVideos playlistVideos, PlayListFragment.LastItemReachedListener lastItemReachedListener) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.mThumbnailImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(holder.mContext , PlayYoutubeActivity.class);
